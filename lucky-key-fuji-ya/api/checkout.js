...
export default async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${req.headers.origin || 'https://TODO-lucky-key-fuji-ya.vercel.app'}/?payment=success`,
      cancel_url:  `${req.headers.origin || 'https://TODO-lucky-key-fuji-ya.vercel.app'}/?payment=cancel`,
    });
