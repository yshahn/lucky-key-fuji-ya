...
Vercel will give you a URL like `https://lucky-key-fuji-ya.vercel.app`, then point `luckykeyfujiyaga.com` at it via DNS.
...
- [x] **Menu data**: full menu (344 items across 6 categories — Chinese Lunch/Dinner, Hibachi Lunch/Dinner, Sushi & Kitchen, Drinks) entered in `js/app.js`
...
- [x] **Categories/sections**: 6 categories seeded (Chinese Lunch, Chinese Dinner, Hibachi Lunch, Hibachi Dinner, Sushi & Kitchen, Drinks) with real menu structure
